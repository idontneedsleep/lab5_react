      ...
      <header>
        ...
        <div class='container'>
            <div class="container2">
                ...
                <Form1/>
                <div class="heading">
                    Склад секретаріату приймальної комісії
                </div>
                <div>
                    <span>Відповідальний секретар</span>
                    <span>Заступник відповідального секретаря</span>
                    <span>Технічний секретар</span>
                </div>
                <div>
                    <div>
                        <h4>Андрій Вікторович Панасюк</h4>
                    </div>
                    <div>
                        <h4>Анатолій Петрович Дикий</h4>
                    </div>
                    <div>
                        <h4>Світлана Ростиславівна Якимчук</h4>
                    </div>
                </div>
            </div>
        </div>
